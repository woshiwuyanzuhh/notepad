// meta 测试：.notebook-meta.json 读写 / 合并 / trash 记录
...
fn save_and_load_roundtrip() {
    ...
    set_note_meta(&mut meta, "工作/a.md", Some(true), Some(false), Some(vec!["工作".into()]), None);
...
fn set_meta_merges_without_losing_other_fields() {
    let mut meta = MetaFile::default();
    set_note_meta(&mut meta, "a.md", Some(true), None, None, None);
    set_note_meta(&mut meta, "a.md", None, Some(true), None, None);
